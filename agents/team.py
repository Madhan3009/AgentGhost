...
class GhostRequirementTeam:
    ...
    def _build_team(self) -> Team:
        ...
        team = Team(
            ...
            instructions=[
                ...
                "- score >= 0.97: Near-verbatim duplicate. Return resolution_type='exact_match_found'. No Agent 3 needed.",
                "- score 0.65-0.97: Conflict zone. Delegate to 'Conflict Resolver' with the requirement + ticket context.",
                "  (High similarity 0.85-0.97 means same topic but possibly contradictory specifics — ALWAYS delegate to Conflict Resolver)",
    ...
    def _build_prompt(
        ...
        lines += [
            ...
            "   - similarity >= 0.97 → exact_match_found (near-verbatim duplicate, no Agent 3 needed)",
            "   - similarity 0.65-0.97 → delegate to 'Conflict Resolver' for contradiction check",
            "     (similarity 0.85-0.97 means same topic but possibly different values — always check for contradiction)",
